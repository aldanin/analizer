...
import MailAppViewer from './';
import { MailAppViewerProps } from './';
...
it('renders without crashing', () => {
  ...
  const props: MailAppViewerProps = {
    isFetching: false,
    requestUpdate: () => null,
    lastExtraction: 0,
  ...
  ReactDOM.render(<MuiThemeProvider><MailAppViewer {...props}/></MuiThemeProvider>, div);
});
