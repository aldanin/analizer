...
import * as AppViewHeaderToolbarTheme from '../Common/AppViewHeaderTool/Theme'
...
export interface ThemeProps {
  ...
  tabs?: TabsThemeProps,
  appViewHeaderTool: AppViewHeaderToolbarTheme.ThemeProps
}
...
export const defaultTheme = {
  ...
  appViewHeaderTool: AppViewHeaderToolbarTheme.DEFAULT_THEME,
}
